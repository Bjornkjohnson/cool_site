...
const playfieldTilemap: Tile[][] = [
  [CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CAVE_, CAVE_, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF],
  [CLIFF, CLIFF, CLIFF, CLIFF, CLIFF, CL_TL, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF, CLIFF, CLIFF, CLIFF, CLIFF],
  [CLIFF, CLIFF, CLIFF, CLIFF, CL_TL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF, CLIFF, CLIFF, CLIFF],
  [CLIFF, CLIFF, CLIFF, CL_TL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF, CLIFF, CLIFF],
  [CLIFF, CLIFF, CL_TL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF, CLIFF],
  [CLIFF, CL_TL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF, CLIFF],
  [CL_TL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_TR, CLIFF],
  [CL_BL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_BR, CLIFF],
  [CLIFF, CL_BL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_BR, CLIFF, CLIFF],
  [CLIFF, CLIFF, CL_BL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_BR, CLIFF, CLIFF, CLIFF],
  [CLIFF, CLIFF, CLIFF, CL_BL, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, SAND_, CL_BR, CLIFF, CLIFF, CLIFF, CLIFF],
];
